...
export const appRoutes: Route[] = [
    ...
    // Redirect signed-in user to the '/summary'
    { path: 'editor-redirect', pathMatch: 'full', redirectTo: 'hiring/hiring-room' },
    ...
    // Auth routes for guests
    {
        ...
        children: [
            ...
            {path: 'confirm/:token', loadChildren: () => import('app/modules/auth/email-confirmation/email-confirmation.routes')}
        ]
    },
